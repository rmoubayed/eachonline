...
export const routes: Routes = [
    { 
        ...
        component: PagesComponent, children: [
            ...
            { path: 'learn/manufactures', loadChildren: './pages/contact/contact.module#ContactModule', data: { breadcrumb: 'Manufactures' } },
            { path: 'learn/wholesalers', loadChildren: './pages/contact/contact.module#ContactModule', data: { breadcrumb: 'Wholesalers' } },
            { path: 'learn/retailers-and-stores', loadChildren: './pages/contact/contact.module#ContactModule', data: { breadcrumb: 'Retailers & Stores' } },
            { path: 'partners', loadChildren: './pages/contact/contact.module#ContactModule', data: { breadcrumb: 'Partners' } },
            { path: 'learn/services-providers', loadChildren: './pages/contact/contact.module#ContactModule', data: { breadcrumb: 'Services Providers' } },
            { path: 'learn/concierge-managers', loadChildren: './pages/contact/contact.module#ContactModule', data: { breadcrumb: 'Concierge Managers' } },
            { path: 'learn/regional-managers', loadChildren: './pages/contact/contact.module#ContactModule', data: { breadcrumb: 'Regional Managers' } },
